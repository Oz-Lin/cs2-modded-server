...
# As root (sudo su)
# cd / && curl -s -H "Cache-Control: no-cache" -o "install.sh" "https://raw.githubusercontent.com/oz-lin/cs2-modded-server/master/install.sh" && chmod +x install.sh && bash install.sh
...
curl -s -H "Cache-Control: no-cache" -o "stop.sh" "https://raw.githubusercontent.com/oz-lin/cs2-modded-server/${BRANCH}/stop.sh" && chmod +x stop.sh

# Download latest start script
curl -s -H "Cache-Control: no-cache" -o "start.sh" "https://raw.githubusercontent.com/oz-lin/cs2-modded-server/${BRANCH}/start.sh" && chmod +x start.sh
...
wget --quiet https://github.com/oz-lin/cs2-modded-server/archive/${BRANCH}.zip
